...
cp_comp_move            cp          select_x            select_x1
                        ...
                        cp          chk_vld_mv_vld_p    chk_vld_mv_vld
...
skip_to_reg             bne         pre_draw_piece      chk_vld_mv_vld_p    one         
                        ...
                        bne         chk_king            chk_vld_mv_mid_p    one
                        cp          jumps_again         zero
...
pre_draw_piece          be          pre_draw_jumps      jumps_again     one
                        bne         pre_draw_jumps      chk_vld_mv_vld_p    one
                        not         turnvar             turnvar
                        cp          jumps_again         zero
...
ai_loop_e               bne         no_ai               turnvar                 zero
                        ...
                        not         turnvar             turnvar
                        be          pre_draw_jumps      zero                    zero
ai_loop_m               bne         no_ai               turnvar                 zero
                        //call ai here
                        call        m_start_ai          m_retvar
                        not         turnvar             turnvar
                        be          pre_draw_jumps      zero                    zero
...
chk_vld_mv_midloc_p     .data       0
chk_vld_mv_king_p       .data       0
chk_vld_mv_mid_p        .data       0
chk_vld_mv_vld_p        .data       0
jumps_again             .data       0
piece_old               .data       0      
p_i                     .data       0
start_draw_x            .data       0
